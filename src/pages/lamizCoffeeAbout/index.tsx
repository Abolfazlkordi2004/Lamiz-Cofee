...
function AboutPage() {
  const [branches, setBranches] = useState<IData[]>([]);
  ...
  useEffect(() => {
    const fetchBranches = async () => {
      try {
        ...
        setError("خطا در دریافت اطلاعات شعب");
        console.error(err);
      } finally {
        setLoading(false);
      }
    ...
    <div>
      ...
      <div className="w-full h-[3800px]">
        ...
        >
          ...
          <div className="mt-5 w-full text-lg text-justify space-y-5">
            <p>
        ...
        >
          ...
          <div className="mt-10 w-full text-lg text-justify space-y-5">
            <p>
        ...
        <div className="relative w-full h-[450px] mt-10">
          ...
          >
            ...
            <div className="w-[1120px] mt-5 space-y-5">
              <p className="text-white text-lg text-justify font-semibold">
                هدف ما نه تنها ارائه بهترین قهوه و محصول با بهترین قیمت و بهترین
                سرویس در قابل دسترس‌ترین نقاط شهر (و جاده‌ها) بوده و هست، بلکه
                انتقال انرژی خوب و بهتر‌کردن روز مشتریانمان، ایفای مسئولیت
                اجتماعی در راستای اصول و‌ ارزش‌هایمان و ایجاد اشتغال و محیط کاری
                سالم و قابل پیشرفت است.
              </p>
              <p className="text-white text-lg text-justify font-semibold">
