...
const LamizCare: React.FC = () => {
  ...
  const handleSubmit = async (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      await axios.post("http://localhost:3001/submitFeedback", formData);
      ...
      <div className="h-auto w-full">
        <div className="w-[1100px] mx-auto mt-15" dir="rtl">
          ...
          <div className="relative w-full text-right mt-15">
            <label htmlFor="phoneNumber" className="text-lg font-semibold text-gray-800">
              شماره تماس
            </label>
            <input
              type="text"
          ...
          <div className="relative w-full text-right mt-15">
            <label htmlFor="order" className="text-lg font-semibold text-gray-800">
          ...
          <div className="flex flex-col mt-10">
            <h2 className="text-lg font-semibold text-gray-800">
              ...
              هستید &quot;YOU&apos;RE GOING TO FEEL BETTER SOON&quot; است. آیا شعبه ما را با
              احساس بهتری ترک می‌کنید؟
            </h2>
            <div className="flex flex-row gap-5 mt-5">
              <div>
                <input
          ...
          <div className="w-[200px] h-[50px] bg-[#FE6E1F] mt-15 rounded flex items-center justify-center text-white text-lg font-semibold cursor-pointer mb-15">
            <button onClick={handleSubmit}>ارسال انتقادات و پیشنهادات</button>
          </div>
          {submitStatus && (
            <p
